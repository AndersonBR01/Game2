...
//vereficar se acertou todas as cartas
const checkEndGame = () =>{
...
// vereficar se são iguais checar as cartas
const checkCard = ()=>{
...
const revealCard =({target}) =>{
    ...
    //1° target.parentNode.classList.add('reveal-card');
}
